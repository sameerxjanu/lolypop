        ...
        <div className="flex animate-marquee whitespace-nowrap flex-nowrap items-center shrink-0 justify-start gap-0">
          {items.map((item, i) => (
            <React.Fragment key={i}>
              <span className="text-2xl md:text-4xl font-bold uppercase font-display tracking-tight px-6">
                {item}
              </span>
              <span className="text-2xl md:text-4xl font-bold px-6 text-black/30">//</span>
            </React.Fragment>
          ))}
        </div>

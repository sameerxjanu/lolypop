...
const Hero: React.FC = () => {
  ...
  return (
    <section ref={containerRef} className="relative w-full min-h-[500px] md:min-h-[calc(100vh-80px)] flex flex-col items-center justify-start pt-4 md:pt-8 pb-8 overflow-hidden bg-white">
      ...
      {/* Top Badges */}
      <motion.div
        className="flex flex-row flex-wrap gap-4 justify-center mb-6 md:mb-8 relative z-10 items-center transform scale-90 md:scale-100"
        initial={{ opacity: 0, y: -20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.6, delay: 0.2 }}
      >
        <button
          className="bg-loly-pink text-white text-base md:text-lg font-black px-5 py-2 rounded-full border border-black shadow-neo-lg hover:shadow-neo hover:translate-x-[2px] hover:translate-y-[2px] active:shadow-neo-active active:translate-x-[4px] active:translate-y-[4px] transition-all cursor-pointer flex items-center gap-2 group"
        >
          <span className="animate-wiggle-slow inline-block group-hover:scale-125 transition-transform">🚀</span> MEMECOINS
        </button>
        <button
          className="bg-loly-purple text-white text-base md:text-lg font-black px-5 py-2 rounded-full border border-black shadow-neo-lg hover:shadow-neo hover:translate-x-[2px] hover:translate-y-[2px] active:shadow-neo-active active:translate-x-[4px] active:translate-y-[4px] transition-all cursor-pointer flex items-center gap-2 group"
        >
          <span className="animate-bounce-slow inline-block group-hover:rotate-12 transition-transform">🎰</span> BETTING
        </button>
        <button
          className="bg-loly-green text-white text-base md:text-lg font-black px-5 py-2 rounded-full border border-black shadow-neo-lg hover:shadow-neo hover:translate-x-[2px] hover:translate-y-[2px] active:shadow-neo-active active:translate-x-[4px] active:translate-y-[4px] transition-all cursor-pointer flex items-center gap-2 group"
        >
      ...
      {/* Main Heading */}
      <div className="text-center max-w-6xl px-4 relative z-10 flex flex-col justify-center items-center flex-1">
        <h1 className="text-black text-5xl md:text-8xl font-black leading-[0.9] tracking-tight mb-4 md:mb-6 uppercase">
          ...
          <span className="bg-clip-text text-transparent bg-gradient-to-r from-loly-pink via-loly-purple to-loly-green bg-[length:300%_auto] animate-liquid relative inline-block py-1 md:py-2">
        ...
        >
          ...
          <span className="text-black font-black px-1 ml-1">
        ...
        >
          <button
            ...
            className="bg-white text-black text-base font-black py-3 px-8 rounded-full border border-black flex items-center gap-2 group relative overflow-hidden transition-all duration-200 shadow-neo-lg hover:shadow-neo hover:translate-x-[2px] hover:translate-y-[2px] active:shadow-neo-active active:translate-x-[4px] active:translate-y-[4px]"
          >
          ...
          <button
            ...
            className="bg-white text-black text-base font-black py-3 px-8 rounded-full border border-black flex items-center gap-2 group transition-all duration-200 shadow-neo-lg hover:shadow-neo hover:translate-x-[2px] hover:translate-y-[2px] active:shadow-neo-active active:translate-x-[4px] active:translate-y-[4px]"
          >
